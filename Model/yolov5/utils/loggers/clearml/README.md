...
```bash
python train.py --img 640 --batch 16 --epochs 3 --data coco128.yaml --weights smock_v5.pt --cache
```

or with custom project and task name:

```bash
python train.py --project my_project --name my_training --img 640 --batch 16 --epochs 3 --data coco128.yaml --weights smock_v5.pt --cache
```
...
```bash
python train.py --img 640 --batch 16 --epochs 3 --data clearml://<your_dataset_id> --weights smock_v5.pt --cache
```
